...
$sql = mysqli_query($con,"SELECT *FROM tb_register ORDER BY id_register DESC LIMIT 1") or die(mysqli_error($con));
...
<div class="panel panel-default">
  <div class="panel-heading"><h3> <span class="glyphicon glyphicon-list-alt"></span> Proof of Registrasion</h3></div>
